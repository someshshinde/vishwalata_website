	...
	<div class="container">
		...
		<div class="row">
			<div class="active-popular-carusel">
				...
				<?php
					echo "<h4 class='text-center'>No Course Found</h4>";
				endif; ?>
			</div>
		</div>
	</div>
	...
	<div class="container">
		...
		<div class="row">
			<div class="active-upcoming-event-carusel">
				...
				<?php
					echo "<h4 class='text-center'>No Events Found</h4>";
				endif; ?>
...
<?php
include_once(APPPATH . 'Views/frontend/inc/placement-partners-section.php');
?>
